...
const MCQPractice = () => {
  ...
  const handleFileUpload = async (event) => {
    ...
    setIsLoading(true);
    try {
      const data = await generateQuestions(file, numQuestions, difficulty);
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <Card className="p-4 shadow-sm">
              <label className="block text-sm font-bold text-gray-700 mb-2">Number of Questions: {numQuestions}</label>
              <input 
            ...
            <Card className="p-4 shadow-sm">
              ...
              <select 
                ...
                className="w-full p-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[hsl(var(--color-primary))]"
              >
            ...
            >
              <div className="bg-blue-50 rounded-xl p-5 border border-blue-100 flex gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-blue-900 mb-1 text-sm uppercase tracking-wide">AI Explanation</h4>
                  <p className="text-blue-800 text-sm leading-relaxed font-medium">{question.explanation}</p>
                </div>
              </div>
            </motion.div>
          )}
