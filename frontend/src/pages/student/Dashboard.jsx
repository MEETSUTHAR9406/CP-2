...
import { Trophy, Flame, Target, ArrowUpRight, Medal, BookOpen, Clock, Brain } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 flex-wrap">
        ...
        <div className="flex gap-3 w-full md:w-auto flex-wrap">
          <Link to="/student/knowledge-map" className="flex-1 sm:flex-none">
            <Button variant="outline" size="sm" className="w-full justify-center border-indigo-200 text-indigo-700 hover:bg-indigo-50">
              <Brain size={16} className="mr-2" /> View My Brain
            </Button>
          </Link>
